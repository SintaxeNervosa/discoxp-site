...
export function Address({ setSelectAddress, changeVisibityForm, ParentElement, showForm, onFormAddressSelect, onFormAddress }) {
    ...
    const onFormAddressOrChangeVisibityForm = () => {
            ...
            <div className="enderecos">
                <div className="enderecos__header">
                    ...
                    <button className="add-endereco"
                        onClick={onFormAddressOrChangeVisibityForm} >
                        + Adicionar endereço
                    </button>
                </div>
